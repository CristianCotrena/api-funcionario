<div align="center">
  <h2>
    Este repositório se refere ao Micro Serviço ( API-Funcionário ) 
    <br>
    <br>
...
### Etapa 1: (Concluída)
✅ ~~Implementado api-funcionário~~

---

### Etapa 2: (Concluída)
✅ ~~Conexão com o banco de dados PostgreSQL na CloudService Railway~~
✅ ~~Implementado tabela `funcionário` básica (sem relacionamento com outras tabelas)~~
